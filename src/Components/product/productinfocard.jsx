import Addtocartbutton from "../button/addtocartbutton"; // Importing Add to Cart button component
import Wishlistbutton from "../button/wishlistbutton"; // Importing Wishlist button component
  ...
  return (
    <div className="flex w-[1400px] bg-white gap-2 px-3 pt-3 pb-3 border-[#24A3B5] hover:border-2">
      ...
      <div className="flex flex-col gap-2 mt-3 ml-3 mr-3">
        <h1 className="text-[#353535] text-[18px] font-bold flex justify-between overflow-x-auto">
          {name}{" "}
          <span>
            <Wishlistbutton />
          </span>
