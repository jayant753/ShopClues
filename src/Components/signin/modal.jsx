...
const Modal = ({ isVisible, onClose }) => {
  ...
  // If the modal is not visible, return null (modal will not render)
  ...
  return (
    <div className="z-50 fixed inset-0 bg-black bg-opacity-25 justify-center items-center flex">
      <div className="w-[800px] h-[600px] bg-white flex">
        {/* Left side panel with icons and descriptions */}
        ...
        {/* Right side panel with login/register form */}
        <div>
          <div className="flex gap-10 w-[565px] h-[50px] justify-between pt-5">
            ...
            <div className="flex gap-7 pl-5 ">
              ...
              <button
                className={`text-[19px] h-[19px] w-[61.77px] ${
                  showLogin ? "text-[#24a3b5] " : "text-[#757575]"
                }`}
              ...
              <button
                className={`text-[19px] h-[19px] w-[88.19px] ${
                  showLogin ? "text-[#757575]" : "text-[#24a3b5]"
                }`}
            ...
            {/* Close button */}
            <div className="pr-4 text-[#757575]">
              <button onClick={onClose}>X</button>
            </div>
          </div>
          {/* Login or Register form based on showLogin state */}
