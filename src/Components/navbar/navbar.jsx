...
// Navbar component
const Navbar = () => {
  // State to control visibility of Signindropdown component
  const [showComponent, setShowComponent] = useState(false);
  // State to control visibility of Modal component
  ...
  // Function to show Signindropdown component
  const handleMouseEnter = () => {
    setShowComponent(true);
  };

  // Function to hide Signindropdown component
        ...
        <div className="w-full h-[61px] flex items-center justify-between pr-32 pl-32">
          ...
          <div className="flex items-center border rounded-lg overflow-hidden text-gray-700 bg-[#e9f6f7] w-[1040px] h-[40px]">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#ff8750] text-white"
            >
              Search
            </button>
          </div>
          {/* Navbar icons and user section */}
          <div className="flex gap-4 items-center pr-16">
            ...
            <div className="relative">
              ...
              {/* Conditional rendering of Signindropdown component */}
              {showComponent && (
