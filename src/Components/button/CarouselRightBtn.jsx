...
function CarouselRightBtn({ toggleSelectRight }) {
    return (
        <button onClick={toggleSelectRight} className='absolute z-10 sm:top-1/3 top-1/4 right-0 md:text-3xl sm:text-2xl text-xl border rounded sm:px-2 px-1 sm:py-4 py-2 duration-200'>
